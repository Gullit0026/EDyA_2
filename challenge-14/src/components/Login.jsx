        ...
        <div>
          <form onSubmit={(e) => e.preventDefault()}>
            ...
            <input
              ...
              required
            />
            <button className="register-button" type="button" onClick={handleEmailRegister}>Registrarse</button>
            <button className="login-button" type="button" onClick={handleEmailLogin}>Iniciar sesión</button>
          </form>

          <button className="google-button" onClick={handleGoogleLogin}>Iniciar sesión con Google</button>
